                ...
                <div class="card-body">
                    <form method="POST" action="{{route('profiles.store')}}"enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email"@disabled(true) class="form-control @error('email') is-invalid @enderror" name="email" value="{{$users->email}}" required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth"
                                 value="{{$users->date_of_birth->format('Y-m-d')}}" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <img src='{{asset("profiles/$users->profile_pic")}}' alt="post images"width="140"height="80">
                                <input type="file" 
